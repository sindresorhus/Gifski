...
//		if let attachments = CVBufferGetAttachments(pixelBuffer, .shouldPropagate) as? [String: Any],
//		   let colorSpace = attachments[kCVImageBufferCGColorSpaceKey as String] as? CGColorSpace {
//			return colorSpace
//		}
//		return nil
	}
